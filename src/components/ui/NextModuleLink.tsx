  ...
  return (
    <div className="mt-5 flex flex-col items-end justify-end">
      <Link
        ...
        className={`flex py-2 text-center gap-2 items-center uppercase w-fit px-4 sm:px-8 lg:px-10 text-sm sm:text-base font-bold rounded-lg border-2 border-accent
          ${!isQuizSubmitted
            ? 'border-foreground cursor-not-allowed opacity-50'
